...
// let operrator = prompt('select an operator','/,*,-,+')
...
// }
// else{
    //     alert('tumse naw hopayega')
// }

// alert(`result of ${num1} ${operrator} ${num2} is : ${result}`)
//  let arr = [1,4,5,8]
//  let arr1 = [2,10,9,7]
//  let merge = [...arr,...arr1]
//  let sort = merge.sort((a,b)=>{
    ...
    //  deleteing dupplicate items in array or also sort the array
    
//     let arr1 = [1,2,6,8,17,10]
//     let arr2 = [4,8,6,19,12,17,10]
//     let unionArr = [...arr1,...arr2]
// let unSorted = [...new Set(unionArr)];
